...
--
-- Name: orders orders_1; Type: RULE; Schema: public; Owner: postgres
--

CREATE RULE orders_1 AS
...
--
-- Name: orders orders_2; Type: RULE; Schema: public; Owner: postgres
--

CREATE RULE orders_2 AS
    ON INSERT TO public.orders
